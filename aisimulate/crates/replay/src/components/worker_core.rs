...
use aisimulate_engine::{
    NativeCommand, NativeCommandResult, NativeGeneralizedEngine, NativeKvEvent,
    NativePressureEvent, NativeRequest, SchedulerCommand,
};
...
pub(crate) struct ReplayWorkerPass {
    ...
    pub(crate) pressure_events: Vec<NativePressureEvent>,
...
impl ReplayWorkerCore {
    ...
    pub(crate) fn execute_pass(
        ...
        for rank in started.by_rank {
            ...
            pressure_events.extend(rank.effects.pressure_events);
