...
/// Native scheduler action taken to relieve KV pressure.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum NativePressureKind {
...
pub struct NativePressureState {
...
pub struct NativePassStartEffects {
    ...
    pub pressure_events: Vec<NativePressureEvent>,
    pub kv_events: Vec<NativeKvEvent>,
}
