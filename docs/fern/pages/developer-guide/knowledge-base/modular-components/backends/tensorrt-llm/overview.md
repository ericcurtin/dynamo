...
| [**Conditional Disaggregation**](../../router/disaggregated-serving.md#conditional-disaggregation) | ✅ | Requires KV-aware routing and `--publish-kv-events` on prefill and decode workers |
